...
def on_agent_event_callback(event, uuid, name, event_data, my_data):
    try:
        ...
        assert isinstance(agent_object, OrderManager)
...
# inputs
def manual_order_input_callback(iop_type, name, value_type, value, my_data):
    try:
        agent_object = my_data
        assert isinstance(agent_object, OrderManager)
        agent_object.manual_orderI = value
        # add code here if needed
    except:
        print(traceback.format_exc())
...
if __name__ == "__main__":
    ...
    igs.input_create("manual_order", igs.DATA_T, None)

    igs.output_create("order_result", igs.DATA_T, None)

    igs.observe_input("manual_order", manual_order_input_callback, agent)
